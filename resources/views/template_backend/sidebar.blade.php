        ...
        <span class="sidebar-menu">
            ...
            <li @if(Request::segment(1) == 'post') class="dropdown active" @endif>
                ...
                <ul class="dropdown-menu">
                    <li
                        @if(Request::segment(1) == 'post' AND count(Request::segments()) == 1)class="active"
                        @endif>
                        <a class="nav-link active" href="{{route('post.index')}}">List Post</a>
                    </li>
                    <li @if(Request::segment(2) == 'trash')class="active" @endif>
                        <a class="nav-link active" href="{{route('post.trash')}}">List Sampah</a>
                    </li>
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    <li @if(Request::segment(1) == 'category')class="active" @endif>
            ...
            <li @if(Request::segment(1) == 'tag') class="dropdown active" @endif>
                ...
                <ul class="dropdown-menu">
                    <li @if(Request::segment(1) == 'tag')class="active" @endif>
